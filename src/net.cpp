...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "elikeme " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"elikemetools.com", "192.168.28.129"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"elikemetools.com", "testnet-seed.elikemetools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. elikeme is probably already running."), addrBind.ToString().c_str());
        else
